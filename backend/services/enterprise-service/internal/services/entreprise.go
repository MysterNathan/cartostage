...
//	println("enterprise-service get me: " + strconv.Itoa(enterpriseID))
//	return s.repo.GetByID(enterpriseID)
//}
//
//// Create - Crée une nouvelle entreprise (pour admin)
//func (s *EnterpriseService) Create(enterprise-service *models.Enterprise) (*models.Enterprise, error) {
//	return s.repo.Create(enterprise-service)
//}
//
//// Update - Met à jour une entreprise (pour admin ou l'entreprise elle-même)
//func (s *EnterpriseService) Update(id int, enterprise-service *models.Enterprise) (*models.Enterprise, error) {
//	return s.repo.Update(id, enterprise-service)
//}
//

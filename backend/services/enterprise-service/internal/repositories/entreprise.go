...
//	var enterprise-service models.Enterprise
//	query := `
...
//    `
//
//	err := r.db.Get(&enterprise-service, query, id)
//	if err != nil {
//		if err == sql.ErrNoRows {
//			return nil, errors.New("enterprise-service not found")
//		}
//		return nil, err
//	}
//
//	return &enterprise-service, nil
//}
//
...
//}
//
//// GetStageByID - Récupère un stage-service par son ID
//func (r *EnterpriseRepository) GetStageByID(stageID int) (*models.Stage, error) {
//	var stage-service models.Stage
//	query := `
...
//    `
//
//	err := r.db.Get(&stage-service, query, stageID)
//	if err != nil {
//		if err == sql.ErrNoRows {
...
//func (r *EnterpriseRepository) Create(enterprise-service *models.Enterprise) (*models.Enterprise, error) {
//	query := `
...
//		enterprise-service.Nom, enterprise-service.Adresse, enterprise-service.Secteur,
//		enterprise-service.Taille, enterprise-service.Siret, enterprise-service.Email,
//		enterprise-service.Telephone, enterprise-service.SiteWeb, enterprise-service.Description,
//		enterprise-service.LogoURL,
//	).Scan(&enterprise-service.ID, &enterprise-service.CreatedAt, &enterprise-service.UpdatedAt)
//
//	if err != nil {
//		return nil, err
//	}
...
//func (r *EnterpriseRepository) Update(id int, enterprise-service *models.Enterprise) (*models.Enterprise, error) {
//	query := `
//        UPDATE enterprises
...
//		enterprise-service.Taille, enterprise-service.Siret, enterprise-service.Email,
//		enterprise-service.Telephone, enterprise-service.SiteWeb, enterprise-service.Description,
//		enterprise-service.LogoURL, id,
//	).Scan(&enterprise-service.CreatedAt, &enterprise-service.UpdatedAt)
//
//	if err != nil {
//		return nil, err
//	}
//
//	enterprise-service.ID = id
//	return enterprise-service, nil
//}
//
...
//
//	if rowsAffected == 0 {
//		return errors.New("enterprise-service not found")
//	}
//
//	return nil
//}
...
//	enterprise-service, err := r.GetByID(id)
//	if err != nil {
//		return nil, err
//	}
//
//	result.Enterprise = *enterprise-service
//

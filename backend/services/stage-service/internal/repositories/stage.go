...
func (r *StageRepository) UpdateStage(ctx context.Context, stage *models.Stage) error {
	...
	if err != nil {
		return fmt.Errorf("erreur lors de l'update du stage-service: %v", err)
	}
...
func (r *StageRepository) GetStageByID(ctx context.Context, id int) (*models.Stage, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("erreur lors de la récupération du stage-service: %v", err)
	}
...
func (r *StageRepository) CreateStage(ctx context.Context, stage *models.Stage) (*models.Stage, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("erreur lors de l'insertion du stage-service: %v", err)
	}
	log.Println("stage-service: ", stage.ID, stage.CreatedAt, stage.UpdatedAt)
	return stage, nil
}
...
func (r *StageRepository) DeleteStage(ctx context.Context, id int) error {
	...
	if err != nil {
		return fmt.Errorf("erreur lors de la suppression du stage-service: %v", err)
	}
	...
	if rowsAffected == 0 {
		return fmt.Errorf("stage-service not found")
	}

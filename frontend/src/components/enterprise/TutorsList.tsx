...
import { addTutor, updateTutor } from '@/lib/enterpriseApi'
...
interface TutorsListProps {
    ...
    onAdd: () => void
    loading: boolean
    onTutorAdded?: (tutor: Tutor) => void
    onTutorUpdated?: (tutor: Tutor) => void
}

export default function TutorsList({ tutors, onEdit, onAdd, loading, onTutorAdded, onTutorUpdated }: TutorsListProps) {

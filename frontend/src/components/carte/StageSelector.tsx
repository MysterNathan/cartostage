          ...
          <div className="flex flex-col items-center mt-4 space-y-2">
            ...
            {selectedStage && (
              <div 
                ...
                title={`Stage sélectionné: ${selectedStage.stage_offer.job_family}`}
              />
            )}
          ...
          <div className="p-4 space-y-3">
            {filteredStages.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-700">Aucun stage trouvé</p>
                ...
                filteredStages.map((stage) => (
                    <div
                        ...
                        className={`p-4 rounded-lg border cursor-pointer transition-all hover:shadow-md ${
                            selectedStage?.id === stage.stage_offer.id
            ...
            <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                stage.stage_offer.filiere === 'CCST'
              ...
              {stage.stage_offer.filiere}
                      ...
                      <div className="mb-2">
                        <h4 className="font-semibold text-gray-900 text-sm leading-tight mb-1">
                          {stage.stage_offer.job_family}
                        </h4>
                        <p className="text-sm text-gray-700 font-medium">
                          {stage.stage_offer.enterprise}
                        </p>
                        {stage.stage_offer.sector && (
                            <p className="text-xs text-gray-600">{stage.stage_offer.sector}</p>
                        )}
                      </div>

                      {stage.stage_offer.period && (
